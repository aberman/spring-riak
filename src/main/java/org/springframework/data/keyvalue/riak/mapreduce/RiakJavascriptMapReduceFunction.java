 ...
 * 
 */
public abstract class RiakJavascriptMapReduceFunction implements
	...
	public static class RiakJavascriptSourceFunction extends
			RiakJavascriptMapReduceFunction {

		private String src;

		public RiakJavascriptSourceFunction(String src) {
			this.src = src;
		}
	}
}
